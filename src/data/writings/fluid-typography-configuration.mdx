...
Good typography is essential for a good web experience. Get it right and you're in a league of your own. It almost feels like cheating. I don't care how good your iconography, color, or layout is. If the typography is off, it throws everything out of whack.
...
Wrong. Meet your new best friend: `createFluidValue`. Credit to [Brett Smith](https://twitter.com/_brettsmith) for writing the original function implementation.
